...
public final class Lab1 {
    public static void main(String[] args) {
        ...
        System.out.println(makeString('a', 5));
        System.out.println(writeChars(5));
        System.out.println(getSubstring("Hello World", 'H', 'd'));
    ...
    public static String makeString(char first, int n) {
        if (n == 0) {
            ...
            return first + makeString(first, n-1); // if n = 1, then it returns first + "", which is just first
        }
    }
    ...
    public static String writeChars(int n) {
        ...
        if (n == 2) {
            ...
            return "<" + writeChars(n-2) + ">"; // if n=5 then it returns "<" + writeChars(3) + ">"
        }
    }
    ...
    }   // 1 + 1 + 1 + 0 + 1 = not 5 but 23 because the remainder is added to the left of the string
}
