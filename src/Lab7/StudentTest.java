...
public class StudentTest {
    ...
    } // check if the exception is thrown. if it is, then the test passes
    ...
    public void test_01_06_() {
        ...
        // this test case checks if the course is dropped, and if the course is no longer in the list of courses
    }
    ...
    public void test_03_02_() {
        ...
        int actual = s1.compareTo(s2);
        int expected = -1; // as id isn't equal, it should return -1
        assertEquals("compareTo() Failed!" + expected + " expected but " + actual + " is given", expected, actual);
    }
